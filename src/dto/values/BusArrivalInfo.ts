export class Station {
  ...
  constructor(id: number, stationName: string) {
    this.setId(id);
...
export class BusStationInfo {
  ...
  constructor(station: Station, busArrivalInfo: BusArrivalInfo[]) {
...
export class BusArrivalInfo {
  ...
  public static of(busArrivalInfo: BusArrivalInfo) {
